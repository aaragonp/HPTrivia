...
//  HP Trivia
//
//  Created by Alberto Aragón Peci on 27/10/24.
//
            ...
            VStack {
                ...
                ScrollView {
                    ...
                    VStack(alignment: .leading) {
                        Text("Welcome to HP Triva! In this game, you will be asked random questions from the HP Book and you must guess the right answer or you will lose points!😱")
